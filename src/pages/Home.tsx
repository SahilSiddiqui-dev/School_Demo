...
export const Home = ({ onEnquire }: Props) => (
  <>
    {/* HERO */}
    <section id="home" className="relative min-h-[100svh] flex items-center pt-20 pb-32 md:pb-20 scroll-mt-20 overflow-hidden">
      <img
        src={heroImg}
      ...
      <div className="container relative z-10 text-primary-foreground">
        <div className="max-w-2xl animate-fade-up">
          ...
          <p className="text-base md:text-lg text-primary-foreground/90 mb-8 max-w-xl leading-relaxed">
            For 25 years, Akash Academy has been raising thoughtful, curious children in the heart of the city. Come see for yourself.
          </p>
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <a
              ...
              className="inline-flex items-center justify-center h-14 px-8 rounded-xl border border-primary-foreground/35 text-primary-foreground font-semibold hover:bg-primary-foreground/10 hover:border-primary-foreground/60 transition-smooth"
            >
              Call Admissions
            </a>
          </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
          {highlights.map(({ icon: Icon, title, desc }, index) => (
            <ScrollReveal key={title} delay={index * 100} className="h-full">
              <div
                className="group h-full p-6 rounded-3xl bg-card border border-border/70 shadow-soft hover:shadow-card hover:-translate-y-1.5 transition-smooth premium-grid relative overflow-hidden"
              >
                <div className="absolute top-0 right-0 w-24 h-24 bg-secondary/5 rounded-bl-full pointer-events-none group-hover:bg-secondary/10 transition-smooth" />
                <div className="w-12 h-12 rounded-xl gradient-gold flex items-center justify-center mb-4 group-hover:scale-110 transition-smooth shadow-soft">
    ...
    <section className="py-20 md:py-28 bg-muted/40 relative overflow-hidden">
      ...
      <div className="container grid md:grid-cols-5 gap-10 md:gap-14 items-center relative">
        <div className="md:col-span-2">
          <ScrollReveal animation="slide-right">
            <div className="relative">
              <div className="absolute -inset-3 gradient-gold rounded-3xl opacity-20 blur-xl" />
              <img
                src={principalImg}
                ...
                width={768}
                height={896}
                className="relative rounded-3xl shadow-card w-full max-w-sm mx-auto object-cover aspect-[4/5] hover:scale-[1.02] transition-smooth duration-500"
              />
            </div>
          </ScrollReveal>
        </div>
      ...
      <div className="container">
        <ScrollReveal>
          <div className="relative overflow-hidden rounded-3xl gradient-navy p-10 md:p-16 text-center text-primary-foreground shadow-card">
            <div className="absolute -top-20 -right-20 w-64 h-64 rounded-full bg-secondary/20 blur-3xl pointer-events-none" />
            <div className="absolute inset-0 premium-grid opacity-10 pointer-events-none" />
